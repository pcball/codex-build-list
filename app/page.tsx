...
function Icon({ name, size=18 }:{ name:"plus"|"search"|"grid"|"box"|"spark"|"trash"|"edit"|"arrow"|"close"|"settings"|"lock"|"unlock"; size?:number }) {
  const paths = {
    ...
    edit:<><path d="M4 20h4L19 9l-4-4L4 16v4Z" /><path d="m13 7 4 4" /></>, arrow:<><path d="M5 12h14M14 7l5 5-5 5" /></>, close:<><path d="m6 6 12 12M18 6 6 18" /></>,
